...
@RestController
@RequestMapping("/api/jhimicroservice-kafka")
public class JhimicroserviceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhimicroserviceKafkaResource.class);
    ...
    public JhimicroserviceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
